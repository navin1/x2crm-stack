...
x2.DetailView = (function() {
    function DetailView(argsDict) {
        var defaultArgs = {
            inlineEdit: false,
        };
    ...
    DetailView.prototype = auxlib.create(x2.RecordView.prototype);
    ...
    DetailView.prototype.setUpInlineEditor = function () {
