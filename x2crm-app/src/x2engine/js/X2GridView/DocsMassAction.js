...
x2.DocsMassAction = (function () {

function DocsMassAction (argsDict) {
...
DocsMassAction.prototype = auxlib.create (x2.MassAction.prototype);

/**
 * Add type (doc or folder) and record id of selected rows to params 
 */
DocsMassAction.prototype.getExecuteParams = function () {
    var that = this;
