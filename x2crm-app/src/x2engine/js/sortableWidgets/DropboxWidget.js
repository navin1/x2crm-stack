...
DropboxWidget = (function () {

function DropboxWidget (argsDict) {
    var defaultArgs = {
        DEBUG: x2.DEBUG && false,
        lastDropboxPostId: null,
        screenName: null
    };
...
DropboxWidget.prototype = auxlib.create (SortableWidget.prototype);

DropboxWidget.prototype._loadMoreDropboxPosts = function (reload) {
    ...
    if (!reload) {
        data.maxDropboxPostId = this.lastDropboxPostId;
    }
    if (this.screenName) {
...
DropboxWidget.prototype._setUpPaginationButtonBehavior = function () {
    var that = this;
    this._paginationButton$.click (function () {
        that._loadMoreDropboxPosts (); 
    });
};

DropboxWidget.prototype._setUpScreenNameSelection = function () {
    var that = this;
    ...
    screenNameSelector$.change (function () {
        ...
        that._loadMoreDropboxPosts (true);
    });
};

DropboxWidget.prototype._init = function () {
    SortableWidget.prototype._init.call (this);
    if (!this.hasError) {
        this._paginationButton$ = this.element.find ('.load-more-dropboxPosts-button');
