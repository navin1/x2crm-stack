 ...
 */
function EmailsWidget (argsDict) {
    var defaultArgs = {
        modelName: null,
        modelId: null,
        actionType: null,
...
EmailsWidget.prototype = auxlib.create (x2.TransactionalViewWidget.prototype);
...
EmailsWidget.prototype._setUpCreateButtonBehavior = function () {
    var that = this;
