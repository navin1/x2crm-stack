...
/**
 * Auto log email console command.
 *
 * Handles command line execution of the EmailInboxes module auto logging
 * @package application.commands
 * @author Raymond Colebaugh <raymond@x2engine.com>
 */
class LogEmailCommand extends CConsoleCommand {
    ...
    /**
     * Log all recent inbound emails on enabled EmailInboxes
     */
