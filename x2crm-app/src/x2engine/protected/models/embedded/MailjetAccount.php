 ...
 */
class MailjetAccount extends EmailAccount {
    ...
    public $security = 'tls';
    public $senderName = '';
    public $server = 'in-v3.mailjet.com';
    public $user = '';

    public function attributeLabels(){
        return array(
            'senderName' => Yii::t('app','Sender Name'),
            'user' => Yii::t('app', 'Username (API Key)'),
            'email' => Yii::t('app','Email'),
            'password' => Yii::t('app','Password (Secret Key)'),
        );
    }

    public function modelLabel() {
        return Yii::t('app','Mailjet Email Account');
    }
    ...
    public function rules(){
        return array(
            array('email', 'email'),
            array('senderName,email,user,password', 'required'),
            array('senderName,email,user,password', 'safe'),
        );
    }
