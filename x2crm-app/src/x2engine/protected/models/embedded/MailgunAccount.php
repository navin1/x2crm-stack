...
/**
 * Authentication data for using a Mailgun account to send email.
 *
 * Similar to EmailAccount but with certain details already filled in
 * @package application.models.embedded
 */
class MailgunAccount extends EmailAccount {
    ...
    public $security = 'tls';
    public $senderName = '';
    public $server = 'smtp.mailgun.org';
    public $user = '';
    ...
    public function modelLabel() {
        return Yii::t('app','Mailgun Email Account');
    }
