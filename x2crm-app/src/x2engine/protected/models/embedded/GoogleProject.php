...
class GoogleProject extends JSONEmbeddedModel implements AdminOwnedCredentials {
    ...
    public function renderForm () {
        Yii::app()->controller->renderPartial (
            'application.views.profile._googleProjectForm', array (
                'model' => $this
            ));
    }
...
//    }
    ...
    public function modelLabel() {
        return Yii::t('app','Google Integration');
    }
    ...
    public function htmlOptions ($name, $options=array ()) {
        return X2Html::mergeHtmlOptions (
            parent::htmlOptions ($name, $options), array ('class' => 'google-credential-input'));
    }
