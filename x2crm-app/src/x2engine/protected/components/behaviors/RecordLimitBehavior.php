 ...
 */
class RecordLimitBehavior extends CActiveRecordBehavior {

    /**
     * @var int $limit max number of records
     */
    public $limit; 

    /**
     * @var string $timestampField will be used to find oldest record 
     */
    ...
    private function getStaticModel () {
        if (!isset ($this->_staticModel)) {
            $class = get_class ($this->owner);
            $this->_staticModel = $class::model ();
        }
