 ...
 */
class OpportunitiesGridViewProfileWidget extends ProfileGridViewWidget {

    public $canBeDeleted = true;

    public $defaultTitle = 'Opportunities Summary'; 
    ...
    protected function getModel () {
        if (!isset ($this->_model)) {
            $this->_model = new Opportunity ('search',
                $this->widgetKey,
