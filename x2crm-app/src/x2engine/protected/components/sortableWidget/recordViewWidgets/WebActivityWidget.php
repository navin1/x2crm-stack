 ...
 */
class WebActivityWidget extends TransactionalViewWidget {

    protected $labelIconClass = 'fa-globe'; 
    protected $historyType = 'webactivity';
