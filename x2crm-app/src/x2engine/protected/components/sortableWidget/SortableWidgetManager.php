...
class SortableWidgetManager extends X2Widget {

    /**
     * @var string $JSClass
     */
    public $JSClass = 'SortableWidgetManager'; 
    ...
    public function getPackages () {
        if (!isset ($this->_packages)) {
            $this->_packages = array_merge (parent::getPackages (), array (
                'SortableWidgetManagerJS' => array(
                    'baseUrl' => Yii::app()->request->baseUrl,
                    'js' => array(
				        'js/sortableWidgets/SortableWidgetManager.js',
                    ),
