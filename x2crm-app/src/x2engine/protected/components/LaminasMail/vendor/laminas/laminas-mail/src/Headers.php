...
class Headers implements Countable, Iterator
{
    ...
    public static function fromString($string, $EOL = self::EOL)
    {
        ...
        $currentLine = '';
        $emptyLine   = 0;
        //printR(base64_encode($string),1);
        // iterate the header lines, some might be continuations
        //this will be a check for "X-MS-Exchange-MessageSentRepresentingType" which indicates that it was sent by outlook for another email
