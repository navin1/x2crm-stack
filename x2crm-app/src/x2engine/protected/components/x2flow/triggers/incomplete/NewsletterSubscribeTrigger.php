 ...
 */
class NewsletterSubscribeTrigger extends X2FlowTrigger {
	public $title = 'Subscribed to a Newsletter';
	public $info = 'Triggers when a visitor subscribes their email to a newsletter.';
