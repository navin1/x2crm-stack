...
class X2FlowWorkflowCompleteStage extends BaseX2FlowWorkflowStageAction {
    ...
    public $info = 'Completes a process stage.';
    ...
    public function execute(&$params) {
        ...
        if (Workflow::validateAction(
            ...
            list ($started, $workflowStatus) = Workflow::completeStage(
                            $workflowId, $stageNumber, $model, $stageComment, false, $workflowStatus);
            assert($started);
            return array(true, Yii::t('studio', 'Stage "{stageName}" completed for {recordName}', array(
