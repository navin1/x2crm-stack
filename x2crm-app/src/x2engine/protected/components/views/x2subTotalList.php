...
Yii::app()->clientScript->registerScript('x2subTotalListViewJS'.$this->id,"

;(function () {
    var subList = new x2.ConditionList ({
    ...
    $('#$this->id').data ('x2subTotalList', subList);
}) ();
...
<div id='<?php echo $this->id ?>'>
    ...
    <div class='x2fields-template' style='display: none;'>
        ...
        <div class="cell x2fields-value" style="display: none">
