...
class X2SubTotalList extends X2Widget {
    ...
    public function init () {
	    ...
	    $this->attributes = $this->model->getFieldsForDropdown ($this->useLinkedModels);
            /**
	     * This was to disable linked fields showing up.
	     * $this->attributes = $this->model->getFieldsForDropdown (false);
	     */
        }
    }
