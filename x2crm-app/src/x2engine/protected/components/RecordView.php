...
abstract class RecordView extends X2Widget {
    ...
    public function renderItem ($item) {
        ...
        if (!isset($this->_fields[$fieldName])) { // Open Source condition
            return;
        }
    ...
    public function renderHtmlBlockTextArea ($item) {
       return '<td class="attribute" colspan="2"><div class="formInputBox " style=""><span class="model-attribute" style="align: center;">'.$item['blockData'].'</span></div></td>';
    }
