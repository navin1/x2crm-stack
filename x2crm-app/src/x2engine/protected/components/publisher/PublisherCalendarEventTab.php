 ...
 */
class PublisherCalendarEventTab extends PublisherEventTab {
    ...
    public function getInnerViewFile () {
        if (!isset ($this->_innerViewFile)) {
            $this->_innerViewFile = 'application.modules.actions.views.actions._calendarEventForm';
        }
    ...
    public function getModelType () {
        if (!isset ($this->_modelType)) {
            $this->_modelType = 'CalendarEventFormModel';
        }
