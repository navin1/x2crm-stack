...
class MobileRecentItems extends CComponent {

    private static $_recentItems;
    public static function getRecentItems () {
        if (!isset (self::$_recentItems)) {
            ...
            foreach (self::$_recentItems as &$item) { // satisfy CListView by adding key field
    ...
    public static function getDataProvider ($pageSize=null) {
