...
Yii::app()->clientScript->registerScriptFile(
    Yii::app()->controller->module->assetsUrl.'/js/RecordIndexControllerBase.js');
Yii::app()->clientScript->registerScriptFile(
...
<?php
echo CHtml::encode (Yii::t('mobile', 'Recent Items'));
?>
</h1>
</div>
<?php
...
$this->widget (
    ...
    array (
        ...
        'template' => '{items}',
        'itemView' => 'application.modules.mobile.views.mobile._recentItemsItem',
        'htmlOptions' => array (
