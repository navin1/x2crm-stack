...
<div class='profile-header'>    
    <div class='avatar'>
        ...
        if (Yii::app()->params->isPhoneGap && $model->id === Yii::app()->params->profile->id) {
            echo CHtml::link (Yii::t('app', 'Upload photo'), '#', array (
...
$this->widget ('application.modules.mobile.components.MobileViewLayoutRenderer', array (
    'model' => $model,
