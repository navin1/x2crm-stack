...
x2.VideoButton = (function () {

function VideoButton (argsDict) {
...
VideoButton.prototype.setUpButtonPhoneGap = function () {
    var that = this;
    this.element$.off ('click.setUpButtonPhoneGap').on ('click.setUpButtonPhoneGap', function () {
        that.validate (function () {
            x2touch.API.getVideo(function(mediaFiles) {
...
VideoButton.prototype.setUpButtonBrowser = function () {
    var that = this;
...
VideoButton.prototype.init = function () {
