...
$this->widget('X2GridViewGeneric', array(
	...
	'columns'=>array(
		array(
			...
			'type'=>'raw',
			'value'=>'CHtml::link($data["name"],X2List::getRoute($data["id"], "x2Leads"))',
		),
		array(
			'name'=>'type',
        ...
        array (
            ...
            'updateButtonUrl' => 
                "Yii::app()->createUrl ('/x2Leads/updateList', array ('id' => \$data['id']))",
            'cssClassExpression' =>
                "!is_numeric (\$data['id']) ? 'hide-edit-delete-buttons' : ''",
            'viewButtonUrl' => 
                "X2List::getRoute (\$data['id'], 'x2Leads')",
            'deleteButtonUrl' => 
...
<div class="form">
<?php echo CHtml::link('<span>'.Yii::t('app','New List').'</span>',array('/x2Leads/x2Leads/createList'),array('class'=>'x2-button')); ?>
</div>
