...
$heading = Yii::t('accounts','{module} Lists', array('{module}'=>Modules::displayName(false))); 
...
$this->widget('X2GridViewGeneric', array(
	...
	'template'=> '<div class="page-title icon accounts"><h2>'.$heading.'</h2>{buttons}{filterHint}{summary}</div>{items}{pager}',
	...
	'columns'=>array(
		...
		array(
			...
			'type'=>'raw',
			'value'=>'$data["type"]=="static"? Yii::t("accounts","Static") : Yii::t("accounts","Dynamic")',
		),
		array(
			'name'=>'assignedTo',
        ...
        array (
            ...
            'updateButtonUrl' => 
                "Yii::app()->createUrl ('/accounts/updateList', array ('id' => \$data['id']))",
            'cssClassExpression' =>
...
<div class="form">
<?php echo CHtml::link('<span>'.Yii::t('app','New List').'</span>',array('/accounts/accounts/createList'),array('class'=>'x2-button')); ?>
</div>
