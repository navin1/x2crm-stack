...
$menuOptions = array(
    'index', 'create', 'view', 'edit', 'share', 'delete', 'quick','helpGuide',
);
...
//echo $this->renderPartial('application.components.views.@FORMVIEW', array('model'=>$model, 'modelName'=>'Opportunity')); ?>
