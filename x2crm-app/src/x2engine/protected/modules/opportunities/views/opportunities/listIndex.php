...
$this->widget('X2GridViewGeneric', array(
	...
	'columns'=>array(
		array(
			...
			'type'=>'raw',
			'value'=>'CHtml::link($data["name"],X2List::getRoute($data["id"], "opportunities"))',
		),
		array(
			'name'=>'type',
        ...
        array (
            ...
            'updateButtonUrl' => 
                "Yii::app()->createUrl ('/opportunities/updateList', array ('id' => \$data['id']))",
            'cssClassExpression' =>
...
<div class="form">
<?php echo CHtml::link('<span>'.Yii::t('app','New List').'</span>',array('/opportunity/opportunity/createList'),array('class'=>'x2-button')); ?>
</div>
