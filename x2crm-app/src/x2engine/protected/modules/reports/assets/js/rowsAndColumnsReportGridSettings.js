...
$.widget('x2.rowsAndColumnsReportGridResizing', $.x2.reportGridResizing, {
    _create:function() {
        x2.DEBUG && console.log ('gridReportGridResizing create');
        var that = this;
        this._super ();
    },
    _destroy:function() {
        this._super ();
        this.element.removeData('x2-rowsAndColumnsReportGridResizing');
    },
});
