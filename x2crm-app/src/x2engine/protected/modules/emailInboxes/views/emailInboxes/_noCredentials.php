...
<div id='inbox-body-container' class='inbox-body-container'>
    ...
    <div id='my-email-inbox-reconfigure-instructions-container'>
        <h2><?php 
            echo Yii::t('emailInboxes', 'Your email credentials are not set. Please update your '.
                'inbox\'s email credentials.'); 
        ?></h2>
        <a href='<?php echo Yii::app()->createUrl ('emailInboxes/configureMyInbox'); ?>'><?php 
