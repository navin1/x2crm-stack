...
if ($this->selectedMailbox instanceof EmailInboxes && $this->selectedMailbox->credentialId != null) {
	Yii::import('application.modules.emailInboxes.components.EmailInboxMenu');
	$this->leftWidgets = array (
		'EmailInboxMenu' => array ()
	);
}

$this->renderPartial ('_emailInbox', array (
