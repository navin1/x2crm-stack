...
$this->pageTitle = Yii::t('marketing', 'A/B Campaign');
$menuOptions = array(
...
<div class="page-title icon marketing">
    <h2><?php echo Yii::t('marketing','Create an A/B Campaign'); ?></h2>
    <?php echo CHtml::submitButton(Yii::t('module','Create'), array('class'=>'x2-button highlight right')); ?>
</div>

<?php
$this->renderPartial('_formAB', array('model'=>$model, 'modelName'=>'Campaign','form'=>$form));
