...
$menuOptions = array(
    'all', 'create', 'lists', 'newsletters', 'weblead', 'webtracker', 'x2flow', 'helpGuide',
);
...
<div class="page-title icon marketing">
    <h2><?php echo Yii::t('marketing','Create A Long Term Campaign'); ?></h2>
    <?php echo CHtml::submitButton(Yii::t('module','Create'),array('class'=>'x2-button highlight right')); ?>
</div>

<?php
$this->renderPartial('_formLTCemail', array('model'=>$model, 'modelName'=>'Campaign','form'=>$form, 'EmailCount' => $EmailCount));
