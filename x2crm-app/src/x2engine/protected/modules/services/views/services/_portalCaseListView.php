...
<div id="case-listview-container">
	<h5 class="border-bottom border-gray pb-2 mb-0">Service Cases</h6>
	<?php $this->widget('zii.widgets.CListView', array(
		'id'=>'case-listview',
		'dataProvider'=>$dataProvider,
		'itemView'=>'_portalCaseListItem',
		'htmlOptions'=>['class'=>''],
		'summaryCssClass'=>'pb-2 mb-0',
		'summaryTagName'=>'small',
		'summaryText'=>'p.{page}/{pages}',
