        ...
        <div id="tabs" class="form" style="">
            ...
            <div id="tabs-5" class="admin-tab-content">
                ...
                <div class="cell span-6"><?php
                    ...
                    ?></div>
                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'Lead Forms'), array('/whatsappGroups/whatsappGroups/leadForms'));
                    ?><br><?php
                    echo Yii::t('admin', 'Register custom-styled public lead-capture pages and get notified (QR + short link) over WhatsApp');
                    ?></div>
                <?php  ?>
            ...
            <div id="tabs-7" class="admin-tab-content">
                ...
                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'WhatsApp Configuration'), array('/whatsappGroups/whatsappGroups/configure'));
                    ?><br><?php
                    echo Yii::t('admin', 'Manage the WhatsApp integration: connection status, phone number, and pairing');
                    ?></div>

                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'MailerLite API Settings'), array('/mailerlite/mailerlite/apiSettings'));
                    ?><br><?php
                    echo Yii::t('admin', 'Manage the MailerLite API key and connection status (account name/email)');
                    ?></div>

                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'Schedule MailerLite Campaign'), array('/mailerlite/mailerlite/scheduleCampaign'));
                    ?><br><?php
                    echo Yii::t('admin', 'Send a one-time email to a Contact List at a scheduled date and time');
                    ?></div>
